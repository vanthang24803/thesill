        ...
        <div className="py-6 border-b flex flex-col space-y-4">
          ...
          <div className="lg:flex items-center justify-between hidden">
            <span className=" text-neutral-500">
              Get free shipping on all small houseplants. Available in grow pots
              & planters 5 inches in diameter.
            </span>
          ...
          <>
            <div className="flex lg:hidden flex-col space-y-4">
              <span className="text-sm text-neutral-500">
                Get free shipping on all small houseplants. Available in grow
                pots & planters 5 inches in diameter.
              </span>

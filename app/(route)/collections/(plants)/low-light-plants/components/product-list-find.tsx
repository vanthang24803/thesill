      ...
      <div>
        <div className="py-6 border-b flex flex-col space-y-4">
          ...
          <div className="lg:flex items-center justify-between hidden">
            <span className=" text-neutral-500 w-2/3">
              Whether you’re looking for plants for a first floor apartment or
              office cubicle, these low light tolerant picks will survive the
              shade.
            </span>

  ...
  return (
    <div className="w-full h-full">
      <div className="md:flex">
        <Skeleton className="md:basis-1/2 rounded-none lg:h-[62vh] md:h-[35vh] h-[45vh]" />
        <Skeleton className="md:basis-1/2 lg:h-[62vh] rounded-none md:h-[35vh] h-[45vh]" />
      </div>

      <div className="lg:mx-12 md:mx-8 mx-4">
        <div className="mt-8">
          <Skeleton className="lg:w-1/2 w-full lg:h-[7vh] h-[5vh]" />
          <div className="mt-8 grid lg:grid-cols-6 md:grid-cols-3 grid-cols-1 gap-4 md:gap-8">
            {Array(4)
              .fill(0)
              .map((index) => (

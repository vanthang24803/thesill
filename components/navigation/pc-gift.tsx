...
import { gitfs } from "@/components/navigation";
        ...
        <div className="flex justify-between items-center">
          {gitfs.desc.map((item) => (
            <div className="flex flex-col" key={item.image}>
              ...
              />
              <div className="flex items-center gap-x-12 hover:italic hover:text-[#009a7b] hover:cursor-pointer">
